...
<body>
    ...
    <section class="hero bg-success grid md:grid-cols-2">
        ...
        <div class="flex flex-col justify-center space-y-10 pt-10 md:pt-0">
            ...
            <button class="bg-white py-3 px-5 rounded-md shadow-md w-max m-auto text-blue-600 font-bold hover:bg-blue-50 ransition-all">
                Learn Now
            </button>
            </a>
        </div>
        <div class="h-4/6 w-4/6 bg-white shadow-xl m-auto rounded-md pt-4 pl-4">
            <img src="/image/hero-teacher.svg" alt="teacher">
        </div>
    ...
    <section class="grid lg:grid-cols-3 p-5 px-16 gap-10 max-w-md lg:max-w-full mx-auto">
        <div class="bg-white w-full h-60 shadow-xl rounded-md border border-blue-50 flex flex-col justify-center space-y-5 px-10">
            <div class="w-24 h-24 rounded-full mx-auto bg-blue-500 flex p-3">
