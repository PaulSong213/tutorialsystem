            ...
            <div class="row g-0">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <div class="form-outline mb-4">
                        <input id="name" type="text" class="form-control from-control-lg @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
